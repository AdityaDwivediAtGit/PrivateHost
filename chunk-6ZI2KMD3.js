...
var Button = class {
  ...
  render() {
    ...
    return h(Host, { key: "d148ed2332917f03fafd63dbbef10131df0ec5f0", onClick: this.handleClick, "aria-disabled": disabled ? "true" : null, class: createColorClasses(color, {
      [mode]: true,
      [buttonType]: true,
      ...
      "ion-focusable": true
    }) }, h(TagType, Object.assign({ key: "9da73c530017d510839a224bc4d5315bd44f60ed" }, attrs, { class: "button-native", part: "native", disabled, onFocus: this.onFocus, onBlur: this.onBlur }, inheritedAttributes), h("span", { key: "9046184db918cc53e90796860c43d1dfb7d1f85c", class: "button-inner" }, h("slot", { key: "9dd37ab124803e703567ddde4154c81ed1922be1", name: "icon-only", onSlotchange: this.slotChanged }), h("slot", { key: "01713ecf19c68be05072ffcd00ed7ff2d76c4551", name: "start" }), h("slot", { key: "121124874ba1357bc10ffaf4f7ed13803a02add9" }), h("slot", { key: "09317cf5ced153fbb94d4ebba69db858f9dbe570", name: "end" })), mode === "md" && h("ion-ripple-effect", { key: "8bdd9d082f48582be903221b13b67095046cd9aa", type: this.rippleType })));
  }
  get el() {
...
@ionic/core/dist/esm/ion-button_2.entry.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-6ZI2KMD3.js.map
