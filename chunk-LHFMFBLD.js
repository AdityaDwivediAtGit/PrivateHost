...
var Toggle = class {
  constructor(hostRef) {
    ...
    this.setupGesture = async () => {
      ...
      if (toggleTrack) {
        this.gesture = (await import("./chunk-YVWM4FG2.js")).createGesture({
          el: toggleTrack,
          gestureName: "toggle",
          gesturePriority: 100,
          threshold: 5,
  ...
  render() {
    ...
    return h(Host, { key: "f569148edd89ee041a4719ffc4733c16b05229bd", role: "switch", "aria-checked": `${checked}`, "aria-describedby": this.hintTextId, "aria-invalid": this.isInvalid ? "true" : void 0, onClick: this.onClick, "aria-labelledby": hasLabel ? inputLabelId : null, "aria-label": inheritedAttributes["aria-label"] || null, "aria-disabled": disabled ? "true" : null, "aria-required": required ? "true" : void 0, tabindex: disabled ? void 0 : 0, onKeyDown: this.onKeyDown, onFocus: this.onFocus, onBlur: this.onBlur, class: createColorClasses(color, {
      [mode]: true,
      ...
      [`toggle-${rtl}`]: true
    }) }, h("label", { key: "3027f2ac4be6de422a14486d847fbee77f615db1", class: "toggle-wrapper", htmlFor: inputId }, h("input", Object.assign({ key: "4b0304c9e879e432b80184b4e5de37d55c11b436", type: "checkbox", role: "switch", "aria-checked": `${checked}`, checked, disabled, id: inputId, required }, inheritedAttributes)), h("div", { key: "8ef265ec942e7f01ff31cbb202ed146c6bf94e02", class: {
...
@ionic/core/dist/esm/ion-toggle.entry.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-LHFMFBLD.js.map
