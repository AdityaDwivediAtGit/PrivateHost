...
// src/app/features/itinerary-planner/draggable-temple/draggable-temple.ts
var DraggableTempleComponent = class _DraggableTempleComponent {
  temple;
  static \u0275fac = function DraggableTempleComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _DraggableTempleComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DraggableTempleComponent, selectors: [["app-draggable-temple"]], inputs: { temple: "temple" }, decls: 9, vars: 3, consts: [[1, "p-3", "bg-white", "rounded", "shadow", "cursor-move", "hover:shadow-md", "border", "border-gray-200", "flex", "items-center", "gap-3"], [1, "w-12", "h-12", "rounded", "object-cover", 3, "src"], [1, "font-medium", "text-sm"], [1, "text-xs", "text-gray-500"], [1, "ml-auto", "text-gray-400"]], template: function DraggableTempleComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0);
      \u0275\u0275element(1, "img", 1);
      \u0275\u0275elementStart(2, "div")(3, "h4", 2);
      \u0275\u0275text(4);
      \u0275\u0275elementEnd();
    ...
    if (rf & 2) {
      \u0275\u0275advance();
      \u0275\u0275property("src", ctx.temple.imageUrl || "assets/placeholder-temple.jpg", \u0275\u0275sanitizeUrl);
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(ctx.temple.name);
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate(ctx.temple.region);
    }
  }, dependencies: [CommonModule, MatCardModule, MatIconModule, MatIcon], encapsulation: 2 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(DraggableTempleComponent, [{
    type: Component,
    args: [{ selector: "app-draggable-temple", standalone: true, imports: [CommonModule, MatCardModule, MatIconModule], template: `<div class="p-3 bg-white rounded shadow cursor-move hover:shadow-md border border-gray-200 flex items-center gap-3">
    <img [src]="temple.imageUrl || 'assets/placeholder-temple.jpg'" class="w-12 h-12 rounded object-cover">
    <div>
        <h4 class="font-medium text-sm">{{ temple.name }}</h4>
        <p class="text-xs text-gray-500">{{ temple.region }}</p>
    </div>
    <mat-icon class="ml-auto text-gray-400">drag_indicator</mat-icon>
</div>` }]
  }], null, { temple: [{
    type: Input,
    args: [{ required: true }]
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DraggableTempleComponent, { className: "DraggableTempleComponent", filePath: "src/app/features/itinerary-planner/draggable-temple/draggable-temple.ts", lineNumber: 14 });
})();

// src/app/features/itinerary-planner/day-column/day-column.ts
function DayColumnComponent_div_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 4);
    \u0275\u0275element(1, "app-draggable-temple", 5);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
var DayColumnComponent = class _DayColumnComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DayColumnComponent, selectors: [["app-day-column"]], inputs: { dayIndex: "dayIndex", date: "date", temples: "temples" }, outputs: { drop: "drop" }, decls: 6, vars: 6, consts: [[1, "w-full", "bg-gray-50", "rounded-lg", "p-4", "min-h-[500px]", "flex", "flex-col", "gap-3", "border", "border-dashed", "border-gray-300"], [1, "font-semibold", "text-lg", "text-indigo-700"], ["cdkDropList", "", 1, "flex", "flex-col", "gap-2", "min-h-[100px]", 3, "cdkDropListDropped", "cdkDropListData"], ["cdkDrag", "", 4, "ngFor", "ngForOf"], ["cdkDrag", ""], [3, "temple"]], template: function DayColumnComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275listener("cdkDropListDropped", function DayColumnComponent_Template_div_cdkDropListDropped_4_listener($event) {
        return ctx.onDrop($event);
      });
      \u0275\u0275template(5, DayColumnComponent_div_5_Template, 2, 1, "div", 3);
      \u0275\u0275elementEnd()();
    }
    if (rf & 2) {
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate2("Day ", ctx.dayIndex + 1, " - ", \u0275\u0275pipeBind1(3, 4, ctx.date));
      \u0275\u0275advance(2);
      \u0275\u0275property("cdkDropListData", ctx.temples);
      \u0275\u0275advance();
      \u0275\u0275property("ngForOf", ctx.temples);
    }
  }, dependencies: [CommonModule, NgForOf, DragDropModule, CdkDropList, CdkDrag, DraggableTempleComponent, DatePipe], encapsulation: 2 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(DayColumnComponent, [{
    type: Component,
    args: [{ selector: "app-day-column", standalone: true, imports: [CommonModule, DragDropModule, DraggableTempleComponent], template: '<div class="w-full bg-gray-50 rounded-lg p-4 min-h-[500px] flex flex-col gap-3 border border-dashed border-gray-300">\n    <div class="font-semibold text-lg text-indigo-700">Day {{ dayIndex + 1 }} - {{ date | date }}</div>\n\n    <div cdkDropList [cdkDropListData]="temples" class="flex flex-col gap-2 min-h-[100px]"\n        (cdkDropListDropped)="onDrop($event)">\n\n        <div *ngFor="let temple of temples" cdkDrag>\n            <app-draggable-temple [temple]="temple"></app-draggable-temple>\n        </div>\n    </div>\n</div>' }]
  }], null, { dayIndex: [{
    type: Input
  }], date: [{
    type: Input
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DayColumnComponent, { className: "DayColumnComponent", filePath: "src/app/features/itinerary-planner/day-column/day-column.ts", lineNumber: 14 });
})();

// src/app/features/itinerary-planner/planner-page/planner-page.ts
function PlannerPageComponent_div_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 12);
    \u0275\u0275element(1, "app-draggable-temple", 13);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const temple_r1 = ctx.$implicit;
...
function PlannerPageComponent_div_14_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 14)(1, "app-day-column", 15);
    \u0275\u0275listener("drop", function PlannerPageComponent_div_14_Template_app_day_column_drop_1_listener($event) {
      \u0275\u0275restoreView(_r2);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("dayIndex", i_r5)("date", day_r4.date)("temples", day_r4.temples);
  }
}
var PlannerPageComponent = class _PlannerPageComponent {
  store = inject(Store);
  availableTemples$ = this.store.select(selectAllTemples);
  availableTemples = [];
  // Local copy for drag drop
  // Mock Itinerary Days
  days = [
    { date: "2024-01-01", temples: [] },
    { date: "2024-01-02", temples: [] },
    { date: "2024-01-03", temples: [] }
  ];
  ngOnInit() {
    this.store.dispatch(loadTemples());
    this.availableTemples$.subscribe((temples) => {
      this.availableTemples = [...temples];
    });
  }
  drop(event) {
  ...
  static \u0275fac = function PlannerPageComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _PlannerPageComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PlannerPageComponent, selectors: [["app-planner-page"]], decls: 15, vars: 3, consts: [["cdkDropListGroup", "", 1, "flex", "h-screen", "overflow-hidden"], [1, "w-80", "bg-white", "shadow-lg", "z-10", "flex", "flex-col"], [1, "p-4", "bg-indigo-900", "text-white"], [1, "text-xl", "font-bold"], [1, "text-sm", "opacity-80"], [1, "overflow-y-auto", "p-4", "flex-1"], ["cdkDropList", "", 1, "flex", "flex-col", "gap-3", "min-h-[100px]", 3, "cdkDropListDropped", "cdkDropListData"], ["cdkDrag", "", 4, "ngFor", "ngForOf"], [1, "flex-1", "bg-gray-100", "p-8", "overflow-x-auto"], [1, "text-3xl", "font-bold", "mb-6", "text-indigo-900"], [1, "flex", "gap-6"], ["class", "w-80 flex-shrink-0", 4, "ngFor", "ngForOf"], ["cdkDrag", ""], [3, "temple"], [1, "w-80", "flex-shrink-0"], [3, "drop", "dayIndex", "date", "temples"]], template: function PlannerPageComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "div", 2)(3, "h2", 3);
      \u0275\u0275text(4, "Unplanned Temples");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(5, "p", 4);
      \u0275\u0275text(6, "Drag to timeline");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(7, "div", 5)(8, "div", 6);
      \u0275\u0275listener("cdkDropListDropped", function PlannerPageComponent_Template_div_cdkDropListDropped_8_listener($event) {
        return ctx.drop($event);
      });
      \u0275\u0275template(9, PlannerPageComponent_div_9_Template, 2, 1, "div", 7);
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(10, "div", 8)(11, "h1", 9);
      \u0275\u0275text(12, "Itinerary Planner");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(13, "div", 10);
      \u0275\u0275template(14, PlannerPageComponent_div_14_Template, 2, 3, "div", 11);
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(8);
      \u0275\u0275property("cdkDropListData", ctx.availableTemples);
      \u0275\u0275advance();
      \u0275\u0275property("ngForOf", ctx.availableTemples);
      \u0275\u0275advance(5);
      \u0275\u0275property("ngForOf", ctx.days);
    }
  }, dependencies: [CommonModule, NgForOf, DragDropModule, CdkDropList, CdkDropListGroup, CdkDrag, DraggableTempleComponent, DayColumnComponent], encapsulation: 2 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(PlannerPageComponent, [{
    type: Component,
    args: [{ selector: "app-planner-page", standalone: true, imports: [CommonModule, DragDropModule, DraggableTempleComponent, DayColumnComponent], template: '<div class="flex h-screen overflow-hidden" cdkDropListGroup>\n    <!-- Sidebar of Available Temples -->\n    <div class="w-80 bg-white shadow-lg z-10 flex flex-col">\n        <div class="p-4 bg-indigo-900 text-white">\n            <h2 class="text-xl font-bold">Unplanned Temples</h2>\n            <p class="text-sm opacity-80">Drag to timeline</p>\n        </div>\n        <div class="overflow-y-auto p-4 flex-1">\n            <div cdkDropList [cdkDropListData]="availableTemples" class="flex flex-col gap-3 min-h-[100px]"\n                (cdkDropListDropped)="drop($event)">\n                <div *ngFor="let temple of availableTemples" cdkDrag>\n                    <app-draggable-temple [temple]="temple"></app-draggable-temple>\n                </div>\n            </div>\n        </div>\n    </div>\n\n    <!-- Main Canvas -->\n    <div class="flex-1 bg-gray-100 p-8 overflow-x-auto">\n        <h1 class="text-3xl font-bold mb-6 text-indigo-900">Itinerary Planner</h1>\n        <div class="flex gap-6">\n            <div *ngFor="let day of days; let i = index" class="w-80 flex-shrink-0">\n                <app-day-column [dayIndex]="i" [date]="day.date" [temples]="day.temples" (drop)="drop($event)">\n                </app-day-column>\n            </div>\n        </div>\n    </div>\n</div>' }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PlannerPageComponent, { className: "PlannerPageComponent", filePath: "src/app/features/itinerary-planner/planner-page/planner-page.ts", lineNumber: 19 });
})();

// src/app/features/itinerary-planner/itinerary.routes.ts
var itineraryRoutes = [
  {
    path: "",
