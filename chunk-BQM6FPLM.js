...
var RadioGroup = class {
  ...
  render() {
    ...
    return h(Host, { key: "db593b3ed511e9395e3c7bfd91b787328692cd6d", role: "radiogroup", "aria-labelledby": label ? labelId : null, "aria-describedby": this.hintTextId, "aria-invalid": this.isInvalid ? "true" : void 0, onClick: this.onClick, class: mode }, this.renderHintText(), h("div", { key: "85045b45a0100a45f3b9a35d1c5a25ec63d525c4", class: "radio-group-wrapper" }, h("slot", { key: "53dacb87ce62398e78771fb2efaf839ab922d946" })));
  }
  get el() {
    return getElement(this);
  }
...
@ionic/core/dist/esm/ion-radio_2.entry.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-BQM6FPLM.js.map
