...
import "./chunk-KJBBQORM.js";
import {
  isRTL
} from "./chunk-PKLQCMK6.js";
import {
  createLockController
} from "./chunk-MKFE23OS.js";
import {
  attachComponent,
  detachComponent
} from "./chunk-R7O7CF3P.js";
import "./chunk-CUYIUJP7.js";
import {
  createColorClasses,
  hostContext
...
} from "./chunk-7WZJ7TGL.js";
import {
  transition
} from "./chunk-QYRK4LXI.js";
import {
  clamp,
  componentOnReady,
  hasLazyBuild,
  ...
  componentDidLoad() {
    {
      rIC(async () => {
        ...
        if (!config.getBoolean("_testing")) {
          import("./chunk-WORU3IQK.js").then((module) => module.startTapClick(config));
        }
        if (config.getBoolean("statusTap", isHybrid)) {
          import("./chunk-G7MUIOSV.js").then((module) => module.startStatusTap());
        }
        if (config.getBoolean("inputShims", needInputShims())) {
          const platform = isPlatform(window, "ios") ? "ios" : "android";
          import("./chunk-G4VVQANZ.js").then((module) => module.startInputShims(config, platform));
        }
        const hardwareBackButtonModule = await import("./chunk-4R37I5NY.js");
        ...
        if (typeof window !== "undefined") {
          import("./chunk-HHZXQI65.js").then((module) => module.startKeyboardAssist(window));
        }
        import("./chunk-LZQ2N4DU.js").then((module) => this.focusVisible = module.startFocusVisible());
      });
    }
  }
  /**
...
var Content = class {
  ...
  render() {
    ...
    this.resize();
    return h(Host, Object.assign({ key: "cd8781f848d8dc926fe66f43d43c49564425a507", role: isMainContent ? "main" : void 0, class: createColorClasses(this.color, {
      [mode]: true,
    ...
    } }, inheritedAttributes), h("div", { key: "95b112d7cae30f22ef778ceffb88edb4d941c170", ref: (el2) => this.backgroundContentEl = el2, id: "background-content", part: "background" }), fixedSlotPlacement === "before" ? h("slot", { name: "fixed" }) : null, h("div", { key: "2fdfcbc39fb66f11b6191911f2941c660f4c12e5", class: {
      "inner-scroll": true,
      "scroll-x": scrollX,
      "scroll-y": scrollY,
      overscroll: (scrollX || scrollY) && forceOverscroll
    }, ref: (scrollEl) => this.scrollEl = scrollEl, onScroll: this.scrollEvents ? (ev) => this.onScroll(ev) : void 0, part: "scroll" }, h("slot", { key: "6bc77e0054ec8e21635a7f2abfe0ca46e0962e03" })), transitionShadow ? h("div", { class: "transition-effect" }, h("div", { class: "transition-cover" }), h("div", { class: "transition-shadow" })) : null, fixedSlotPlacement === "after" ? h("slot", { name: "fixed" }) : null);
  }
  get el() {
    return getElement(this);
  }
...
var RouterOutlet = class {
  ...
  async connectedCallback() {
    ...
    this.gesture = (await import("./chunk-HYAZZ4FJ.js")).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), (step) => {
      var _a;
...
@ionic/core/dist/esm/ion-app_8.entry.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-IF4DLPVV.js.map
